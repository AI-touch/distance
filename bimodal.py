...
from model import LogicNet,plot_losses,predict,plot_decision_boundary, Multi
...
model = Multi(inputdim=2,hiddendim=3,outputdim=2)#
# 初始化模型
...
src_features1, src_features2, l1, l2  = model.fea_out(xt1, yt1, xt2, yt2)
